...
Thank you for your interest in contributing to llcuda! This guide will help you get started.
...
| Module | Purpose |
|--------|---------|
| `llcuda/server.py` | Server management |
| `llcuda/api/client.py` | API client |
| `llcuda/api/gguf.py` | GGUF parsing |
| `llcuda/api/multigpu.py` | Multi-GPU config |
...
2. ✅ Linting passes: `ruff check llcuda/`
3. ✅ Type checks pass: `mypy llcuda/`
