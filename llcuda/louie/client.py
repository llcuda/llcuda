...
Natural language interface for graph analysis using llcuda inference.
"""
...
class LouieClient:
    ...
    Combines llcuda LLM inference with Louie.AI-style natural language
    processing for graph data analysis.
    
    Example:
        >>> from llcuda.louie import LouieClient
        >>> 
        >>> client = LouieClient()
    ...
    def __init__(
        ...
        Args:
            ...
            use_local_llm: Use local llcuda inference (vs Louie.AI cloud)
    ...
    def _init_llm(self) -> None:
        ...
        if self.use_local_llm:
            try:
                import llcuda
                self._engine = llcuda.InferenceEngine()
    ...
    def _init_graphistry(self) -> None:
        ...
        try:
            from llcuda.graphistry import GraphWorkload
...
def natural_query(
    ...
    **kwargs,
    ...
    Example:
        >>> from llcuda.louie import natural_query
        >>> 
...
def extract_entities(
    ...
    **kwargs,
    ...
    Example:
        >>> from llcuda.louie import extract_entities
        >>> 
...
def extract_relationships(
    ...
    **kwargs,
    ...
    Example:
        >>> from llcuda.louie import extract_relationships
        >>> 
