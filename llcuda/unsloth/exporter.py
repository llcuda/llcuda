...
Export Unsloth fine-tuned models to GGUF format for llcuda inference.
...
class UnslothExporter:
    ...
    llcuda-compatible GGUF files with quantization.
    ...
    def export_with_unsloth_native(
        ...
        try:
            ...
            print("Falling back to llcuda export method...")

            # Fallback to llcuda method
...
def export_to_llcuda(
    ...
    """
    Export Unsloth model for llcuda inference (convenience function).
