# llcuda v2.2.0 Professional Portfolio

This folder contains the professional portfolio PDF and LaTeX source code for the llcuda v2.2.0 project.

## Contents

- `llcuda_v2_2_0_portfolio.pdf` - Compiled 20-page professional portfolio (506 KB)
- `llcuda_v2_2_0_portfolio.tex` - LaTeX source code
...
**Focus:** llcuda v2.2.0 CUDA 12 inference backend for Unsloth on Kaggle
...
3. **Notebooks 01-10** - Core llcuda functionality demonstrations
...
cd /path/to/llcuda/llcuda-pdf-portfolio

# Compile (requires 3 passes for proper references)
pdflatex -interaction=nonstopmode llcuda_v2_2_0_portfolio.tex
pdflatex -interaction=nonstopmode llcuda_v2_2_0_portfolio.tex
pdflatex -interaction=nonstopmode llcuda_v2_2_0_portfolio.tex
```
...
All diagrams follow a clean, vertical column layout inspired by the llcuda.github.io website:
...
- Portfolio focuses exclusively on llcuda v2.2.0 project
- Balanced technical depth suitable for recruiters and hiring managers
- Professional, industry-focused tone
- All diagrams match llcuda.github.io website design language
