...
```
llcuda-pdf-portfolio/
├── compile.sh                      # Automated compilation script
├── .gitignore                      # Git ignore rules for build artifacts
├── llcuda_v2_2_0_portfolio.pdf     # Compiled portfolio (506 KB, 20 pages)
├── llcuda_v2_2_0_portfolio.tex     # LaTeX source code (47 KB)
...
```bash
# Navigate to llcuda project root
cd /media/waqasm86/External1/Project-Nvidia-Office/llcuda

# Add portfolio folder
git add llcuda-pdf-portfolio/

# Commit
git commit -m "Add llcuda v2.2.0 professional portfolio with LaTeX source"
...
**Tracked:**
- `llcuda_v2_2_0_portfolio.pdf` (compiled portfolio)
- `llcuda_v2_2_0_portfolio.tex` (LaTeX source)
- `Makefile` (build automation)
...
### `llcuda_v2_2_0_portfolio.pdf`
- **Size:** 506 KB
- **Pages:** 20
- **Content:** Professional portfolio showcasing llcuda v2.2.0 project
- **Highlights:** 5 TikZ diagrams, 14 tables, Notebook 11 flagship section

### `llcuda_v2_2_0_portfolio.tex`
- **Size:** 47 KB
- **Lines:** ~1,350
...
2. Check llcuda documentation: https://llcuda.github.io
3. View source repository: https://github.com/llcuda/llcuda
