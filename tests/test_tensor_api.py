"""
Test suite for llcuda v2.0 Tensor API
"""
...
try:
    from llcuda.core import Tensor, DType, get_device_count, get_device_properties, matmul
except ImportError as e:
    pytest.skip(f"llcuda native extension not built: {e}", allow_module_level=True)
