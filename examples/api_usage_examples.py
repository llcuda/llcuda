...
def example_quantization():
    ...
    # NF4 Quantization
    print("\n A) NF4 Quantization")
    from llcuda.quantization import quantize_nf4, dequantize_nf4
    ...
    # GGUF Conversion
    print("\n B) GGUF Conversion")
    from llcuda.quantization import GGUFQuantType
...
def example_unsloth_integration():
    ...
    from llcuda.unsloth import check_unsloth_available
...
def example_cuda_optimizations():
    ...
    from llcuda.cuda import check_tensor_core_support, enable_tensor_cores
    ...
    from llcuda.cuda import list_kernels
...
def example_advanced_inference():
    ...
    # FlashAttention
    print("\n A) FlashAttention")
    from llcuda.inference import check_flash_attention_available
