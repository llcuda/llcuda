"""
Complete llcuda Workflow Example: Unsloth to Deployment

This example demonstrates the complete workflow from Unsloth fine-tuning
to llcuda deployment with quantization and optimization.
...
from llcuda.quantization import quantize_dynamic
from llcuda.cuda import enable_tensor_cores, check_tensor_core_support
import torch
...
def export_model_to_gguf(model, tokenizer):
    ...
    # Export using llcuda's Unsloth integration
...
# ============================================================================
# PART 3: Deploy with llcuda
# ============================================================================

def deploy_with_llcuda(model_path):
    """Deploy model with llcuda for fast inference."""
    print("\n" + "=" * 70)
    print("PART 3: Deploy with llcuda")
    print("=" * 70)
...
def demonstrate_advanced_features():
    """Demonstrate advanced llcuda features."""
    print("\n" + "=" * 70)
    ...
    from llcuda.cuda import get_tensor_core_info
...
def main():
    ...
    print("""
╔═══════════════════════════════════════════════════════════════════╗
║       Complete llcuda Workflow: Unsloth to Deployment            ║
