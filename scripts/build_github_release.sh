#!/bin/bash
# Build script for llcuda GitHub release packages
# Creates both source and wheel distributions for GitHub releases

set -e

echo "========================================"
echo "llcuda GitHub Release Build Script"
echo "========================================"
echo ""

# Get version from pyproject.toml
VERSION=$(grep '^version = ' pyproject.toml | cut -d'"' -f2)
echo "Building llcuda v$VERSION for GitHub releases"
echo ""
...
echo "  - dist/llcuda-$VERSION.tar.gz (source)"
echo "  - dist/llcuda-$VERSION-py3-none-any.whl (wheel)"
...
echo "  3. Also upload: llcuda-binaries-cuda12-t4-v$VERSION.tar.gz"
echo ""
