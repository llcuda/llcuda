...
show_header "Create llcuda GitHub Release Package"
...
# llcuda CUDA 12 Binaries - ${TARGET_NAME}
...
### For llcuda Python package:

\`\`\`bash
# Extract to llcuda package directory
tar -xzf llcuda-binaries-cuda12-${TARGET}.tar.gz
...
EOF
    ...
    ARCHIVE_NAME="llcuda-binaries-cuda12-${TARGET}.tar.gz"
