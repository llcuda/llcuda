# llcuda v2.2.0 - Kaggle Guide

Complete guide for using llcuda on Kaggle's dual Tesla T4 GPU environment.

**Build Info:**
- Binary: `llcuda-v2.2.0-cuda12-kaggle-t4x2.tar.gz` (961 MB)
...
Kaggle provides free access to dual Tesla T4 GPUs, making it an excellent platform for LLM inference with llcuda.
...
| 03 | [Multi-GPU](../notebooks/03-multi-gpu-inference-llcuda-v2.2.0.ipynb) | Dual T4 configuration |
| 06 | [Split-GPU](../notebooks/06-split-gpu-graphistry-llcuda-v2.2.0.ipynb) | LLM + RAPIDS |
| 09 | [Large Models](../notebooks/09-large-models-kaggle-llcuda-v2.2.0.ipynb) | 70B on Kaggle |
