# LinkedIn Blog Post — llcuda v2.2.0
...
From GeForce 940M to Kaggle dual Tesla T4 — llcuda v2.2.0 is here.

Last time I wrote about llcuda, it was a proof of concept: local CUDA 12 inference on a GeForce 940M, VRAM down from 820 MB to 200 MB, 42 tok/s on a consumer GPU. The core hypothesis was right — GGUF quantization + llama.cpp makes serious LLM inference accessible without cloud spend.

v2.2.0 flips the script. Same philosophy, different scale.
...
github.com/llcuda/llcuda

---

#llcuda #CUDA #LLM #GGUF #llama_cpp #Kaggle #NVIDIA #Tesla_T4 #RAPIDS #Graphistry #Plotly #Quantization #NeuralNetwork #Visualization #Transformers #OpenSource #DeepLearning #GPU #MachineLearning #AI
