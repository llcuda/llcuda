# llcuda v2.2.0 - Configuration Guide

Complete reference for configuring llcuda server and client components.
...
### llcuda Environment Variables

| Variable | Description | Default |
|----------|-------------|---------|
| `LLCUDA_BINARY_PATH` | Path to binaries | `~/.cache/llcuda/bin` |
| `LLCUDA_MODEL_PATH` | Default model directory | `~/.cache/llcuda/models` |
