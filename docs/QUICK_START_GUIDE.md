# llcuda v2.2.0 - Quick Start (Kaggle Dual T4)
...
**Note:** llcuda v2.2.0 is distributed via GitHub (not PyPI).
...
On first import, llcuda auto-downloads the CUDA binaries (~961 MB) from GitHub Releases.
