# llcuda v2.2.0 - Troubleshooting Guide

Common issues and solutions for llcuda on Kaggle and other environments.
...
**Error:**
```
ModuleNotFoundError: No module named 'llcuda'
```
...
!pip install --default-timeout=100 git+https://github.com/llcuda/llcuda.git
```
...
try:
    import llcuda
    debug_info["llcuda_version"] = llcuda.__version__
except:
...
| Error | Quick Fix |
|-------|-----------|
| `No module named 'llcuda'` | `pip install llcuda` |
