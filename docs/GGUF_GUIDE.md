# llcuda v2.2.0 - GGUF Guide

Complete guide to GGUF format and quantization for llcuda.
...
- [GGUF Parsing with llcuda](#gguf-parsing-with-llcuda)
...
## GGUF Parsing with llcuda

llcuda provides a built-in GGUF parser for model inspection.
