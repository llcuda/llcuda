# llcuda v2.2.0 - API Reference

Complete Python API documentation for llcuda.
...
- [llcuda.server](#llcudaserver)
- [llcuda.api.client](#llcudaapiclient)
- [llcuda.api.gguf](#llcudaapigguf)
- [llcuda.api.multigpu](#llcudaapimultigpu)
...
| Module | Description |
|--------|-------------|
| `llcuda` | Main package, version info |
| `llcuda.server` | Server management (ServerManager, ServerConfig) |
| `llcuda.api.client` | llama.cpp client (LlamaCppClient) |
| `llcuda.api.gguf` | GGUF parsing and quantization |
| `llcuda.api.multigpu` | Multi-GPU configuration |
| `llcuda.api.nccl` | NCCL utilities (PyTorch distributed) |
...
# GGUF utilities
from llcuda.api.gguf import GGUFParser, QUANT_TYPE_INFO
...
```python
from llcuda.api.gguf import QUANT_TYPE_INFO
...
```python
from llcuda.api.gguf import get_quantization_info
...
```python
from llcuda.api.multigpu import (
...
```python
from llcuda.api.multigpu import create_tensor_split_config
...
```python
from llcuda.api.multigpu import GPUInfo
...
```python
from llcuda.server import ServerManager, ServerConfig
from llcuda.exceptions import ServerError, ModelError
