...
This guide covers publishing llcuda v2.2.0 binaries to GitHub Releases.
...
1. Go to the releases page: `https://github.com/llcuda/llcuda/releases`
2. Click **Draft a new release**
3. **Tag:** `v2.2.0`
4. **Title:** `llcuda v2.2.0 - Kaggle Dual T4 CUDA 12 Binaries`
5. **Description:** (example below)
6. **Upload assets:** `llcuda-v2.2.0-cuda12-kaggle-t4x2.tar.gz`
